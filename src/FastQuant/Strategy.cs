...
namespace FastQuant
{
    ...
    public class Strategy
    {
        ...
        {
            return this.framework.Clock.AddReminder(OnReminder, dateTime, data);
        }

        public Reminder AddExchangeReminder(DateTime dateTime, object data = null)
        {
            return this.framework.ExchangeClock.AddReminder(OnExchangeReminder, dateTime, data);
        }
        ...
        {
            this.framework.EventServer.OnLog(new GroupEvent(e, this.framework.GroupManager.GroupById[groupId]));
        }
        ...
        {
            this.framework.EventServer.OnLog(new GroupEvent(data, this.framework.GroupManager.GroupById[groupId]));
        }
