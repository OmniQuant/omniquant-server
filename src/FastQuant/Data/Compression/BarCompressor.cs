...
namespace FastQuant.Data.Compression
{
    ...
    public class PriceSizeItem
    {
        ...
        public PriceSizeItem(double price, int size, int openInt = 0)
        {
            Price = price;
            Size = size;
            OpenInt = openInt;
    ...
    public abstract class BarCompressor
    {
        ...
        {
            this.bar = new Bar(beginTime, endTime, this.instrumentId, barType, this.newBarSize, price, price, price, price, 0, 0);
        }
