...
namespace FastQuant.Data.Compression
{
    ...
    public class TickDataEnumerator : DataEntryEnumerator
    {
        ...
        private readonly TickSeries series;
    }
    ...
    public class BarDataEnumerator : DataEntryEnumerator
    {
        ...
        public override DataEntry Current
        {
            get
            {
                ...
                {
                    new PriceSizeItem(bar.Open, (int)bar.Volume, 0),
                    new PriceSizeItem(bar.High, 0, 0),
                    new PriceSizeItem(bar.Low, 0, 0),
                    new PriceSizeItem(bar.Close, 0, (int)bar.OpenInt)
                });
            }
        }
