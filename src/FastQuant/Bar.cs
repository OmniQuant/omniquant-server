...
namespace FastQuant
{
    ...
    public class Bar : DataObject
    {
        ...
        public override string ToString() => $"{nameof(Bar)} [{OpenDateTime} - {CloseDateTime}] Instrument={InstrumentId} Type={Type} Size={Size} Open={Open} High={High} Low={Low} Close={Close} Volume={Volume}";
    }
}